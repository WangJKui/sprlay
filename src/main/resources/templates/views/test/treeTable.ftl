...
<html>
	<head>
		...
		<style type="text/css">
			/* body{margin:10px auto;width: 750px;} */
			ul{margin-top:5px;}li{margin-top:3px;}
	...
	<body>
		...
		<table class="layui-table layui-form" id="tree-table" ></table><!--lay-size="sm"  -->
...
{
	elem: '#tree-table',// 必须
	url: 'module/test/table-tree.json',// （url和data参数必须设置一个）
	data: [{},{},{},...],
	icon_key: 'title',// 必须
	top_value: 0,
	primary_key: 'id',
	...
	<script type="text/javascript" src="${request.contextPath}/layui/layui.js"></script>
		<script type="text/javascript">
			...
			layui.use(['treeTable','layer','code','form'],function(){
				...
				treeTable.render({
					elem: '#tree-table1',
					url: '../module/test/table-tree.json',
					icon_key: 'title',
					is_checkbox: true,
					cols: [
						{
